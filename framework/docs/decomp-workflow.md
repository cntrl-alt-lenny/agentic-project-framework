...
Rebuild {{GAME_NAME}} from C source code, byte-for-byte identical to
the original ROM.
...
|---|---|---|
| **{{HUMAN_HANDLE}}** | meatspace | You. Sets priorities, picks direction, merges PRs. |
...
4. You ({{HUMAN_HANDLE}}) get a summary from brain and the final say
